#!/usr/bin/env python3
"""Run the original six planners on the paired Figure 10 inputs.

Default: all 16 settings and 300 saved workload seeds per method.
Smoke example: python experiment.py --seeds 1 --workers 1 --points 0.125
...
POINTS = [0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875, 1.0, 1.125, 1.25, 1.375, 1.5, 1.625, 1.75, 1.875, 2.0]
...
def main():
    ...
    run_sensitivity('workload', sorted(args.points), SEEDS[:args.seeds], args.workers, args.output)
