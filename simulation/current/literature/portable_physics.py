"""Portable exact physical kernels used by the literature-comparison environment.
...
and unrelated planning code are omitted. The frozen equations are retained verbatim.
