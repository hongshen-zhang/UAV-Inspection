...
def sweep(frame, study):
    ...
    style(ax)
    if study in ("Figure5", "Figure6", "Figure9", "Figure10", "Figure11"):
        lower = 20 if study in ("Figure9", "Figure11") else 0
        upper = 100 if study == "Figure10" else 70 if study == "Figure9" else 60
        ax.set_ylim(lower, upper)
        ax.set_yticks(np.arange(lower, upper+1, 20 if study == "Figure10" else 10))
