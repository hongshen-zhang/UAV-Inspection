...
class Config:
    ...
    # MTE-Sub alignment controls
    sub_pressure_power: float = 0.0
    sub_bottleneck_weight: float = 0.0

    # MTE-Top controls
    top_risk_z: float = 0.0
    top_recourse_weight: float = 0.0
    top_recourse_lp_discount: float = 0.30
    top_failure_penalty: float = 0.0
    top_risk_e_z: float = 0.0
    top_recourse_blend: float = 0.0
    top_recourse_uncertainty_gain: float = 0.0
    top_downside_weight: float = 0.0
    top_downside_alpha: float = 0.25
    beam_endpoint_diversity: bool = False
    top_mean_anchor_weight: float = 0.0
