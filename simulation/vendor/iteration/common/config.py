...
class Config:
    ...
    # Fixed task-generation cap. Keeping this independent of t_max ensures
    # the mission-time sensitivity experiment changes only T_max.
    task_deadline_cap_s: float = 2110.0
