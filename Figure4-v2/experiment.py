...
Run: python experiment.py --output-dir results
Then: python plot.py --input results/replay.json --output results/figure4-v2.pdf
...
def main():
    ...
    print(json.dumps({'output': str(output), 'seed': args.seed, 'route': row['route'],
                      ...
                      'reference_comparison': result['reference_comparison']}, indent=2))
